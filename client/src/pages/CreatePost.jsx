...
<div className='flex items-center justify-between pt-3 border-t border-gray-300'>
      ...
      )} className='text-sm bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white font-medium px-8 py-2
