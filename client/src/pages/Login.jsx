...
const Login = () => {
  return (
    ...
    <h1 className='text-3xl md:text-4xl md:pb-2 font-bold bg-linear-to-r from-indigo-950 to-indigo-800 bg-clip-text
    text-transparent'>More than just friends truly connect</h1>
  <p className='text-xl md:text-[20px] text-nowrap text-indigo-900 max-w-72
