...
const renderContent = () => {
  ...
  return (
    ...
    bg-balck bg-opacity-90 z-110 flex items-center
    justify-center' style={{backgroundColor: viewStory.media_type === "text" ? viewStory.background_color :
        "#000000"
    }}>
      
      {/* progress bar */}
      <div className='absolute top-0 left-0
      w-full h-1 bg-gray-700'>
