        ...
        <div className='flex gap-4 pb-5'>
            ...
            {/* story cards */}
            {
                stories.map((story, index)=>(
                    ...
                    bg-linear-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`}>
                        ...
                        {
                            story.media_type === 'image' ? <img src={story.media_url} alt="" className='h-full w-full object-cover hover:scale-110
